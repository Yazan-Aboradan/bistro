...
final localeProvider = Provider<Locale>((ref) {
  return const Locale('en'); // Replace this with your actual logic
});
...
class _BirthdatePickerState extends ConsumerState<BirthdatePicker> {
  ...
  Widget build(BuildContext context) {
    final locale = Locale(ref.watch(localeProvider).languageCode);
    double width=MediaQuery.of(context).size.width;
    return Center(
      child: AppContainerWidget(
        padding: [10,0,10,0],
        width: width >700 ?width*0.6:width*0.8,
        height: 150,
...
//
// class AppBirthdayWidget extends StatefulWidget {
//   final DateTime initialDate;
//   final Function(DateTime) onDateChanged;
//   final double? height;
//   final bool isEditMode;
//
//   const AppBirthdayWidget({
//     super.key,
//     required this.initialDate,
//     required this.onDateChanged,
//     this.height,
...
//
//   @override
//   State<AppBirthdayWidget> createState() => _AppBirthdayWidgetState();
// }
//
// class _AppBirthdayWidgetState extends State<AppBirthdayWidget> {
...
//     yearController = FixedExtentScrollController(initialItem: endYear - selectedYear);
//   }
//
...
//
//     final List<int> years = List<int>.generate(endYear - startYear + 1, (i) => endYear - i);
//     final months = [
//       context.localizations.month_january,
//       context.localizations.month_february,
//       context.localizations.month_march,
//       context.localizations.month_april,
//       context.localizations.month_may,
//       context.localizations.month_june,
//       context.localizations.month_july,
//       context.localizations.month_august,
//       context.localizations.month_september,
//       context.localizations.month_october,
//       context.localizations.month_november,
//       context.localizations.month_december,
//     ];
//
//     final List<int> days = _getDaysInMonth(selectedMonth, selectedYear);
...
//                   final newMaxDay = _getDaysInMonth(selectedMonth, selectedYear).length;
//                   if (selectedDay > newMaxDay) selectedDay = newMaxDay;
//                   widget.onDateChanged(DateTime(selectedYear, selectedMonth, selectedDay));
//                 });
//               },
//               children: months.map((m) {
//                 final fallback = '—'; // or use English default
//                 final label = (m.isNotEmpty) ? m : fallback;
...
//   static const double _defaultSelectionOverlayRadius = 0;
//
//   @override
//   Widget build(BuildContext context) {
